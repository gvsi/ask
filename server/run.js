		...
		SyncedCron.add({
			...
			job: function() {
				...
				courses.forEach(function(courseId) {
					...
					var tempUrl,courseUrl = 'https://test-ask.giovannialcantara.com/room/' + currentCourse._id;
					...
					posts.forEach(function(post){
						if(moment(new Date()).diff(moment(post.createdAt), 'hours') < hours){
							tempUrl = 'https://test-ask.giovannialcantara.com/room/' + currentCourse._id +'?p=' + post._id;

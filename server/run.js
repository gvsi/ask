		...
		SyncedCron.add({
			...
			job: function() {
				...
				courses.forEach(function(courseId) {
					...
					var tempUrl,courseUrl = 'https://ask.sli.is.ed.ac.uk/room/' + currentCourse._id;
					...
					posts.forEach(function(post){
						if(moment(new Date()).diff(moment(post.createdAt), 'hours') < hours){
							tempUrl = 'https://ask.sli.is.ed.ac.uk/room/' + currentCourse._id +'?p=' + post._id;
				...
				if(postsCount){
					var emailAttributes = {"emailBody": emailBody, "recipient": "martingeorgiev1995@gmail.com", subject: "Ask digest" };

...
function loadPage(postId) {
    ...
    $('#summernote').summernote({
        ...
        oninit: function() {
            ...
            var noteBtn = '<button id="latexToolbarBtn" type="button" class="btn btn-default btn-sm btn-small" title="LaTeX Equation Editor" data-event="something" tabindex="-1">&#931;</button>';            

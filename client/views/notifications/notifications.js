 Template.notificationsPage.rendered = function (){
...
*/
            ...
            var message = 'Hey Gio, what\'s up?' // Message to display inside the notification
            ...
            if (style == 'Notification Bar') {
                ...
                $('body').pgNotification({
                    ...
                    timeout: 0,
                    type: type,
                    thumbnail: '<img width="40" height="40" style="display: inline-block;" src="img/profiles/martin_avatar2x.jpg" data-src="img/profiles/martin_avatar.jpg" data-src-retina="img/profiles/martin_avatar2x.jpg" alt="">'
                }).show();

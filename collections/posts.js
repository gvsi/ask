    ...
    courseStudents.forEach(function(courseUser) {
      if(courseUser._id != userId){
        ...
        if(courseUser.profile.emailPreferences == 'realTime'){
          var tempUrl = 'https://ask.sli.is.ed.ac.uk/room/' + course._id +'?p=' + postId;
          var courseUrl = 'https://ask.sli.is.ed.ac.uk/room/' + course._id;
          ...
          var emailAttributes = {"emailBody": emailBody, "recipient":  courseUser.profile.email, "subject": "New Question in " + course.name  };

          var unsubscribeUrl = 'https://ask.sli.is.ed.ac.uk/settings/unsubscribe';
    ...
    reportAbuse: function(reportAttributes) {
      ...
      if(reportAttributes.type == "question"){
        ...
        if(post){
          ...
          emailText += 'Link: <a href="https://ask.sli.is.ed.ac.uk/room/' + post.courseId +'?p=' + post._id + '"> Reported Link </a>' ;
        }else{
        ...
        if(answer){
          ...
          emailText += 'Link: <a href="https://ask.sli.is.ed.ac.uk/room/' + post.courseId +'?p=' + post._id + '#'+ answer._id + '"> Reported Link </a>' ;
        }else{
